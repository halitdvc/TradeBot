...
public class DipPipIslemci extends Islemci{

    private BinanceHesap hesap ;
    private String coin ;
    private Indikator kucukEma;
    private Indikator buyukEma;
    ...
    public DipPipIslemci(BinanceHesap hesap , String coin , double riskOrani) throws Exception {
        this.hesap=hesap;
        this.coin=coin;
        kucukEma = new EmaIndikator(6);
        buyukEma = new EmaIndikator(18);
        atr = new AtrIndikator();
        strateji = new DipPipFutures();
    ...
    public void calistir () throws Exception {
        ...
        /*if (kucukEma.hesapla(hesap.getUstTimeFrameList().getSon()) >buyukEma.hesapla(hesap.getUstTimeFrameList().getSon()))
        ...
        if (kucukEma.hesapla(hesap.getUstTimeFrameList().getSon())>buyukEma.hesapla(hesap.getUstTimeFrameList().getSon())){
            ...
            // Ust Trend Sell
            if ( strateji.sell(hesap.getCurrentMumList().getSon()) && !shortIslemdemiyim){
